...
def parse_planewheel_split(level):
    train_file_template = 'data/plane-wheel/annotations/trainlist{:02d}.txt'
    test_file_template = 'data/plane-wheel/annotations/testlist{:02d}.txt'
    class_index_file = 'data/plane-wheel/annotations/classInd.txt'

    def generate_class_index_file():
        """This function will generate a `ClassInd.txt` for plane-wheel in a format
        like UCF101, where class id starts with 1."""
        video_path = 'data/plane-wheel/videos'
        annotation_dir = 'data/plane-wheel/annotations'
